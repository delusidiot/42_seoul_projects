...
void	make_tests(int value_of_b, float value_of_c)
{
	...
	std::cout << "Initialising a Fixed variable b with an int (" << value_of_b << ")." << std::endl;
	const Fixed b(value_of_b);
	std::cout << "Value of b is: " << b << std::endl;

	std::cout << "Initialising a Fixed variable c with a float (" << value_of_c	<< ")" << std::endl;
...
{
	std::cout << "C++ Module 02 ex02 in main function" << std::endl;
	Fixed a;
